...
export default function EvangelicalPage() {
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <div className="flex items-center px-3 py-2 rounded-lg transition duration-300 ease-in-out bg-blue-800">
              <Users className="mr-2 w-5 h-5" /> Evangelical Family
            </div>
          </nav>
        </div>
        {/* Mobile Menu */}
        ...
        <div className="max-w-7xl mx-auto">
          {section === 'about' && (
            <div className="p-6 bg-white rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center"><i data-lucide="info" className="mr-2 text-blue-600" /> About Evangelical Family</h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    <p>Evangelical Family is a fellowship that operates within CEP RP Huye.</p>
                    <p>It is deeply committed to teaching and training those who desire to become true preachers of the Gospel of Jesus Christ.</p>
                    <p>The fellowship strives to help its members clearly understand how to faithfully serve God and to grow in their knowledge of His Word.</p>
                    <p>Members are trained to live a life of faith and to be true witnesses of Christ in their daily lives.</p>
                    <p>They are empowered to better understand what God requires of them and are always encouraged to serve Him in truth and in love.</p>
                  </div>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start"><i data-lucide="users" className="mr-2 text-blue-600 mt-1 flex-shrink-0" /><span><strong>Passionate community</strong> dedicated to evangelism and outreach</span></li>
                    <li className="flex items-start"><i data-lucide="heart-handshake" className="mr-2 text-blue-600 mt-1 flex-shrink-0" /><span><strong>Regular outreach</strong> activities and Gospel-sharing initiatives</span></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {section === 'media' && (
            <div className="p-6 bg-white rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center"><i data-lucide="book-open" className="mr-2 text-blue-600" /> Today's Bible teaching</h2>
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-semibold text-gray-700 mb-4">Today's Bible teaching</h3>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 pl-6 text-sm"><p><strong>Bank:</strong> Bank of Kigali</p><p><strong>Account Name:</strong> CEP Evangelical Family</p><p><strong>Account Number:</strong> To be updated</p><p><strong>Swift Code:</strong> BKIGRWRW</p></div>
                    </div>
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 pl-6 text-sm"><p><strong>MTN:</strong> To be updated</p><p><strong>Airtel:</strong> To be updated</p></div>
                    </div>
                  </div>
                </div>
                <div>
                  <h3 className="text-2xl font-semibold text-gray-700 mb-4">Online Donation</h3>
                  <p className="text-gray-700 mb-4">Paystack verification pending server integration.</p>
              ...
              {!isLoggedIn ? (
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      onSubmit={async (e) => {
                        ...
                        try {
                          ...
                          if (data.success) {
                            ...
                            sessionStorage.setItem('userGroup', data.user.userGroup || 'evangelical')
                            setUserName(data.user.username)
                            setIsLoggedIn(true)
                            window.location.href = '/evangelical/chat'
                          } else {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <button
                          type="button"
                          onClick={() => window.location.href = '/evangelical/forgot-password'}
                        ...
                        <button
                          type="button"
                          onClick={() => window.location.href = '/evangelical/register'}
                          className="text-blue-700 hover:text-blue-900"
                        >
                          Register
                        </button>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-blue-50 p-6 rounded-lg text-center">
                    ...
                    <button onClick={() => (window.location.href = '/evangelical/chat')} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Go to Chat</button>
                  </div>
                </div>
              )}
            </div>
      ...
      <footer className="bg-gray-800 text-white p-4 text-center mt-8">
        <div className="container mx-auto">
          ...
          <p className="text-sm mt-2">Evangelical Family - Sharing the Gospel through word and action</p>
        </div>
      </footer>
