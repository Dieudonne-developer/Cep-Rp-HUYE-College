...
export default function ProtocolPage() {
  ...
  useEffect(() => {
    if (section === 'chat' && isLoggedIn) {
      ...
      socketRef.current.on('connect', () => {
        ...
        if (userName) {
          socketRef.current.emit('set-username', { username: userName, group: 'protocol' })
          socketRef.current.emit('join-room', 'protocol-chat')
        }
      })
  ...
  const sendMessage = (e: React.FormEvent) => {
    ...
    if (newMessage.trim() && userName.trim() && socketRef.current) {
      ...
      setNewMessage('')
      setIsTyping(false)
      socketRef.current.emit('user-typing', { user: userName, isTyping: false, room: 'protocol-chat', group: 'protocol' })
    }
  }
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <div className="flex items-center px-3 py-2 rounded-lg transition duration-300 ease-in-out bg-blue-800">
              <Users className="mr-2 w-5 h-5" /> Protocol Family
            </div>
          </nav>
        </div>
        {/* Mobile Menu */}
        ...
        <div className="max-w-7xl mx-auto">
          {section === 'about' && (
            <div className="p-6 bg-white rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center"><i data-lucide="info" className="mr-2 text-blue-600" /> About Protocol Family</h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    <p>Protocol Family is a ministry that serves under CEP RP Huye, dedicated to organizing and coordinating all activities that take place in the house of God. It is a team responsible for welcoming people, guiding them during services, and maintaining order, cleanliness, and peace throughout worship gatherings.</p>
                    
                    <p>Members of the Protocol Family are known for their calmness, hospitality, and humility in serving God. They consider their responsibilities a sacred duty, knowing that preparing and maintaining order in God's house is a way of honoring Him. This family strives to do everything with integrity, love, and unity so that God's work may flow smoothly and everyone may feel at home in His presence.</p>
                  </div>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start"><i data-lucide="users" className="mr-2 text-blue-600 mt-1 flex-shrink-0" /><span><strong>Dedicated team</strong> committed to excellence and service</span></li>
                    <li className="flex items-start"><i data-lucide="heart-handshake" className="mr-2 text-blue-600 mt-1 flex-shrink-0" /><span><strong>Regular activities</strong> for training, coordination, and fellowship</span></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {section === 'media' && (
            <div className="p-6 bg-white rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center"><i data-lucide="video" className="mr-2 text-blue-600" /> Decorating videos</h2>
              
              {/* Show video count only */}
              <div className="mb-6">
                <div className="text-sm text-gray-600">
                  {`Showing ${mediaCounts.video} decorating video${mediaCounts.video !== 1 ? 's' : ''}`}
                </div>
              </div>

              <div className="mb-8">
                <h3 className="text-2xl font-semibold text-gray-700 mb-4">Decorating videos</h3>
                ...
                {filteredSongs.length === 0 && (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p>No decorating videos available yet.</p>
                  </div>
                )}
              </div>
            </div>
              ...
              {!isLoggedIn ? (
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      onSubmit={async (e) => {
                        ...
                        try {
                          ...
                          if (data.success) {
                            ...
                            sessionStorage.setItem('userGroup', data.user.userGroup || 'protocol')
                            setUserName(data.user.username)
                            setIsLoggedIn(true)
                            window.location.href = '/protocol/chat'
                          } else {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <button
                          type="button"
                          onClick={() => window.location.href = '/protocol/forgot-password'}
                        ...
                        <button
                          type="button"
                          onClick={() => window.location.href = '/protocol/register'}
                          className="text-blue-700 hover:text-blue-900"
                        >
                          Register
                        </button>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-blue-50 p-6 rounded-lg text-center">
                    ...
                    <button onClick={() => (window.location.href = '/protocol/chat')} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Go to Chat</button>
                  </div>
                </div>
              )}
            </div>
      ...
      <footer className="bg-gray-800 text-white p-4 text-center mt-8">
        <div className="container mx-auto">
          ...
          <p className="text-sm mt-2">Protocol Family - Excellence in service and order</p>
        </div>
      </footer>
