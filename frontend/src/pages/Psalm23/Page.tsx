...
export default function Psalm23Page() {
  ...
  useEffect(() => {
    if (section === 'chat' && isLoggedIn) {
      ...
      socketRef.current.on('connect', () => {
        ...
        if (userName) {
          socketRef.current.emit('set-username', { username: userName, group: 'psalm23' })
          socketRef.current.emit('join-room', 'psalm23-chat')
        }
      })
  ...
  const sendMessage = (e: React.FormEvent) => {
    ...
    if (newMessage.trim() && userName.trim() && socketRef.current) {
      ...
      setNewMessage('')
      setIsTyping(false)
      socketRef.current.emit('user-typing', { user: userName, isTyping: false, room: 'psalm23-chat', group: 'psalm23' })
    }
  }
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <div className="flex items-center px-3 py-2 rounded-lg transition duration-300 ease-in-out bg-blue-800">
              <Users className="mr-2 w-5 h-5" /> Psalm 23 Family
            </div>
          </nav>
        </div>
        {/* Mobile Menu */}
        ...
        <div className="max-w-7xl mx-auto">
          {section === 'about' && (
            <div className="p-6 bg-white rounded-lg shadow-md">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center"><i data-lucide="info" className="mr-2 text-blue-600" /> About Psalm 23 Family</h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    <p>Psalm 23 Family aims to help its members understand that God is their true Shepherd—guiding, supporting, and protecting them in all circumstances. They meet regularly to share the Word of God, pray together, and encourage one another to remain steadfast in God's love and unity.</p>
                    
                    <p>Members of this fellowship believe that knowing God as their Shepherd means trusting Him completely—in good times and in difficult moments. They are taught to have a kind heart, to forgive, and to help others just as the Good Shepherd cares for His sheep.</p>
                    
                    <p>Psalm 23 Family engages in acts of compassion such as visiting the sick, supporting the needy, and praying for the poor or those who are suffering—all done in the spirit of Christian love. The group is characterized by humility, love for God, and a generous heart devoted to helping others so that they too may come to know the Lord as their Shepherd.</p>
                    
                    <p>As the Word of God says in Psalm 23:1:</p>
              ...
              {!isLoggedIn ? (
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      onSubmit={async (e) => {
                        ...
                        try {
                          ...
                          if (data.success) {
                            ...
                            sessionStorage.setItem('userGroup', data.user.userGroup || 'psalm23')
                            setUserName(data.user.username)
                            setIsLoggedIn(true)
                            window.location.href = '/psalm23/chat'
                          } else {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <button
                          type="button"
                          onClick={() => window.location.href = '/psalm23/forgot-password'}
                        ...
                        <button
                          type="button"
                          onClick={() => window.location.href = '/psalm23/register'}
                          className="text-blue-700 hover:text-blue-900"
                        >
                          Register
                        </button>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="bg-blue-50 p-6 rounded-lg text-center">
                    ...
                    <button onClick={() => (window.location.href = '/psalm23/chat')} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Go to Chat</button>
                  </div>
                </div>
              )}
            </div>
      ...
      <footer className="bg-gray-800 text-white p-4 text-center mt-8">
        <div className="container mx-auto">
          ...
          <p className="text-sm mt-2">Psalm 23 Family - Growing in faith and serving with purpose</p>
        </div>
      </footer>
